...
class UserSelectionPage1 extends StatefulWidget {
  @override
  _UserSelectionPage1State createState() => _UserSelectionPage1State();
}

class _UserSelectionPage1State extends State<UserSelectionPage1> {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        for (var userDoc in users) {
          ...
          if (userRole == 'user') {
            displayedRole = 'Role: Inspector';
          } else {
            displayedRole = 'Role: $userRole';
          }
